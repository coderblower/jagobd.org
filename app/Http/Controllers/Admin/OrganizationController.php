...
class OrganizationController extends Controller
{
    public function index(Request $request)
    {
        try {
                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function ($data) {
                        return '<div role="group">
                                    <a href="' . route('organization.edit', $data->id) . '" class="btn btn-sm btn-success" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="' . route('organization.destroy', $data->id) . '" class="btn btn-sm btn-danger" onclick="showDeleteConfirm(' . $data->id . ')" title="Delete">
            ...
            return view('back-end.pages.organization.index');
    ...
    {
        try {
            return view('back-end.pages.organization.create');
        } catch (\Exception $exception) {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('organization.index')->with('success', 'Added Successfully');
        } catch (\Exception $exception) {
    ...
    {
        try {
            return view('back-end.pages.organization.edit',compact('organization'));
        } catch (\Exception $exception) {
