...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{route("video.create")}}" class="btn btn-primary mb-2" style="float:right;">Add Video</a>
                </div>
                <div class="col-12">
                    <div class="card">
    ...
    <script>
        var datatable = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'video_embed_src', name: 'video_embed_src', orderable: true,},
                {data: 'youtube_url', name: 'youtube_url', orderable: true},
