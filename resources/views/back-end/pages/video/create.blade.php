                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="videoEmbedSrc" name="video_embed_src" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="youtubeUrl">YouTube Full URL</label>
                                            <textarea class="form-control" id="youtubeUrl" name="youtube_url" required></textarea>
                                        </div>
                                    </div>
                                </div>
