...
@section('title','Ward Committee Rating Event')
@section('content-header')
    <div class="row mb-2 px-2">
        <div class="col-sm-6">
            <h1 class="m-0">Open Application Form for the Ward Committee</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Open Application Form for the Ward Committee</li>
            </ol>
        </div><!-- /.col -->
    </div>
@endsection
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Open Application Form for the Ward Committee</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('rating_event_ward_store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="union" name="union_id" disabled>
                                        <option value="">Select Union</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="ward">Ward</label>
                                    <select class="form-control" id="ward" name="ward_id[]" multiple="multiple" disabled>
                ...
                if (unionID) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (key, value) {
                                $('#ward').append('<option value="' + value.id + '">' + value.name_en + '</option>');
                            });
