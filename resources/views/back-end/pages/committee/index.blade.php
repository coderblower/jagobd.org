...
@section('content-header')
    <div class="row mb-2 px-2">
        <div class="col-sm-6">
            <h1 class="m-0">Committee List</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('committee.create') }}" class="btn btn-primary mb-2" style="float:right;">Add
                        Committee</a>
                </div>
                <div class="col-12">
                    <div class="card">
...
@section('js')
    <script>
        $(document).ready(function() {
            $("#side-committee").addClass('active');
        });
    </script>
    <script>
        ...
        function deleteItem(id) {
            ...
            var url = '{{ route('committee.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
