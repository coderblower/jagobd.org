                        ...
                        <form action="{{route('slider.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputSubtitle" name="description_en">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputSubtitle">Description (BN)</label>
                                    <input type="text" class="form-control" id="exampleInputSubtitle" name="description_bn">
                                </div>
