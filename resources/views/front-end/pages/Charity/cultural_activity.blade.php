...
@section('title', 'Cultural Activity')
@section('content')
    ...
    <div class="container-fluid">
        <div class="container text-center py-4">
            <h1 class="text-black animated slideInDown">
                @if (app()->getLocale() == 'bn')
                    চিকিৎসা ও বাসস্থান সহযোগিতা
                @else
                    Medical and Accommodation Assistance
                @endif
            </h1>
        </div>
    </div>
                            ...
                            data: {
                                ...
                                datasets: [{
                                    ...
                                    data: [12, 19, 3, 5, 2, 3, 7, 8, 12, 10, 5,
                                        7
                                    ], // Example data for twelve months
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="assistance_type" class="form-label">
                                    @if (app()->getLocale() == 'bn')
                                        সহযোগিতার ধরন
                                    @else
                                        Type of Assistance
                                ...
                                <select class="form-select" id="assistance_type" name="assistance_type" required>
                            ...
                            <div class="mb-3">
                                <label class="form-label">
                                    @if (app()->getLocale() == 'bn')
                                        আপনি কি ফাইভ স্টার সদস্য?
                                    @else
                                        Are you a five-star member?
                                    @endif
                                </label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="five_star_member"
                                        id="five_star_yes" value="yes">
                            ...
                            <div id="reference_field" class="mb-3 d-none">
                                ...
                                <div id="reference_list">
                                    ...
                                    <div class="reference-item mb-2">
                                        <input type="text" class="form-control mb-2" name="references[]"
                                            placeholder="@if (app()->getLocale() == 'bn') রেফারেন্স এন্টার করুন @else Enter reference @endif">
                                    </div>
                                </div>
                                <button type="button" id="add_reference" class="btn btn-secondary">
                                    @if (app()->getLocale() == 'bn')
                                        আরও যুক্ত করুন
                                    @else
                                        Add Another
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addReferenceButton.addEventListener('click', function() {
            ...
            if (referenceItems.length >= 5) {
                alert(
                    '@if (app()->getLocale() == 'bn') আপনি সর্বাধিক পাঁচটি রেফারেন্স যোগ করতে পারবেন @else You can add a maximum of five references @endif');
                return;
            }
