        ...
        <div class="col-md-6">
             ...
             <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-2"><strong>@if (app()->getLocale() == 'bn') মোট বৃত্তি: @else Total Scholarships: @endif</strong> $5000</p>
                    <p class="mb-2"><strong>@if (app()->getLocale() == 'bn') সফল বৃত্তি: @else Successful Scholarships: @endif</strong> 8</p>
                </div>
            </div>        
            <script>
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: [12, 19, 3, 5, 2, 3, 7, 8, 12, 10, 5, 7], // Example data for twelve months
            ...
            <div class="list-group shadow-sm">
                <h5 class="list-group-item active">
                    @if (app()->getLocale() == 'bn')
                        বৃত্তির জন্য আবেদনকারীদের তালিকা
                    @else
                        List of Applicants for Scholarship
                    @endif
                </h5>
                <!-- Repeat list items as needed -->
                <div class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="me-auto">
                        <p class="mb-1"><strong>@if (app()->getLocale() == 'bn') নাম: @else Institution Name: @endif</strong> Institution 1</p>
                    ...
                    <a href="#" class="btn btn-primary">@if (app()->getLocale() == 'bn') আবেদন করুন @else Apply @endif</a>
                </div>
                <div class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="me-auto">
                        <p class="mb-1"><strong>@if (app()->getLocale() == 'bn') নাম: @else Institution Name: @endif</strong> Institution 1</p>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="scholarship_amount" class="form-label">@if (app()->getLocale() == 'bn') বৃত্তির পরিমাণ @else Scholarship Amount @endif</label>
