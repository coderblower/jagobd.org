...
@section('title')
    {{ app()->getLocale() == 'bn' ? $notice->title_bn : $notice->title_en }}
@endsection
@section('content')
    <!-- Page Header Start -->
    <div class="container-fluid">
        <div class="container text-center py-4">
            {{-- <h1 class="display-2 text-white mb-4 animated slideInDown">notice</h1> --}}
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <small class="text-muted">
                                        {{ app()->getLocale() == 'bn' ? __('তারিখ') : __('Date') }}: {{ $notice->date }}
                                    </small>
                                </p>
                                <img src="{{ asset($notice->image) }}" class="" alt="{{ $notice->title_en }}"
                                    style="width:100%">
                                <p class="card-text mt-3">
                                    {{ app()->getLocale() == 'bn' ? $notice->description_bn : $notice->description_en }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 d-flex justify-content-center mb-2">
                            <div class="card" style="width: 100%;">
                                ...
                                <h2 class="card-title text-center mt-2">
                                    {{ app()->getLocale() == 'bn' ? __('সর্বশেষ নোটিশ') : __('Latest Notice') }}</h2>

                            </div>
                        </div>
                        @foreach ($notice_latest as $key => $item)
                            <div class="card shadow-sm mb-2">
                                <div class="card-body d-flex">
                                    <div class="col-md-12" style="margin-left:10px">
                                        <h5 class="card-title"><a href="{{ route('notice.details', $item->id) }}">
                                        ...
                                        <p class="card-text">
                                            ...
                                            <a href="{{ route('notice.details', $item->id) }}"><small>
